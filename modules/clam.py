...
class CLAM_SB(nn.Module):
    def __init__(self, input_dim,gate = True, size_arg = "small", dropout = 0., k_sample=8, n_classes=2,
        instance_loss_fn=SmoothTop1SVM(2), subtyping=False,test=False,act='relu'):
...
class CLAM_MB(CLAM_SB):
    ...
    def forward(self, h, label=None, instance_eval=True, return_features=False, return_attn=False):
        if label==None:
            instance_eval=False
        else:
            instance_eval=True
