...
class AttentionGated(nn.Module):
    def __init__(self,input_dim,act='relu',bias=False,dropout=False):
...
class DAttention(nn.Module):
    def __init__(self,input_dim,n_classes,dropout,act):
        ...
        self.apply(initialize_weights)
    def forward(self, x, return_attn=False,no_norm=False,return_M=False):
        ...
        if len(feature.shape)==2:
            ...
            raise ValueError("Unexpected shape for feature")
